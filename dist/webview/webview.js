...
handlers.set("result", (id, note, line) => __awaiter(void 0, void 0, void 0, function* () {
    if (searchId != id)
        return false;
    return true;
}));
